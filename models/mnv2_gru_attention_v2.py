...
class MobilenetV2GRUAttention(nn.Module):
    def __init__(self, vocab_size, embedding_dim=300, hidden_dim=512, embeddings=None):
        super(MobilenetV2GRUAttention, self).__init__()
        ...
        self.encoder = nn.Sequential(*modules[:-5])
        ...
        self.f_beta_gate = nn.Sequential(
            ...
            nn.GroupNorm(16, enc_out_channels_1),
            nn.Sigmoid(),
        )
        ...
        self.gru = nn.GRU(embedding_dim + enc_out_channels_1, hidden_dim, num_layers=1, bidirectional=False,
...
if __name__ == '__main__':
    ...
    net = MobilenetV2GRUAttention(vocab_size=vocab_size)
